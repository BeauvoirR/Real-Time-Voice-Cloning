...
from encoder.config import get_audio_params
...
mel_window_length = audio_params["mel_window_length"]
mel_window_step = audio_params["mel_window_step"]
mel_n_channels = audio_params["mel_n_channels"]
audio_norm_target_dBFS = audio_params["audio_norm_target_dBFS"]
